    ...
    return (
        <div className="faq-container">
            ...
            <section>
                ...
                <p>
                    RandoRande is a unique date ideas app designed to spark
            ...
            <section>
                ...
                <ol>
                    <li>
                        <h3>Choose Your Search Parameters:</h3>
                        <p>
                ...
                <section>
                    ...
                    <p>
                        Each date suggestion comes with a key featuring icons to
                        provide additional details. For example, you might find
                        icons indicating whether it's advisable not to eat
                        before, dress comfortably, or any other relevant
                        information.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        new experiences with your significant other.
                    </p>
                </section>
                <section>
