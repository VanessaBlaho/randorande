            ...
            <div className="about-us_container_style" style={aboutUsStyle}>
                <div className="container">
                    ...
                    <div className="about_us__text">
                        <p>
                            <strong>RandoRande</strong> is a date ideas
                            generator and personal date journal. The web
                            application was developed by 4 classmates at Coding
                            Bootcamp Praha in November 2023 in Prague, Czech
                            Republic.
                        </p>
                        ...
                        <p>
                            ...
                            ", and the Czech word for date "
                            <strong>rande</strong>", which is a loanword
                            borrowed from the French word "
                            <strong>rendezvous</strong>
                            ". <i>Rendezvous</i> means a meet-up between 2 or
                            more people.
                        </p>

                        <p>
                            Paired up with someone special but at a loss for
                            what to do? We've taken out all the guesswork for
                            you.
                        </p>
                    </div>
